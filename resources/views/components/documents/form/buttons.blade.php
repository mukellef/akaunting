<x-form.section>
    <x-slot name="foot">
        <div class="flex justify-end">
            ...
            <x-button
                id="invoice-send-to"
                class="relative flex items-center justify-center bg-green hover:bg-green-500 text-white px-6 py-1.5 ltr:ml-2 rtl:mr-2 text-base disabled:bg-green-100 transition duration-150 ease-in-out rounded-full"
                override="class"
