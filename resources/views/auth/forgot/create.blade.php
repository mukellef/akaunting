<x-layouts.auth>
    ...
    <x-slot name="content">
        <div>
            <img src="{{ asset('public/img/akaunting-logo-green.svg') }}" class="w-16" alt="Workhy Books" />
        ...
        <x-form id="auth" route="forgot">
            <div class="grid sm:grid-cols-6 gap-x-8 gap-y-6 items-center my-3.5 lg:h-64">
                ...
                <x-button
                    ...
                    class="relative flex items-center justify-center bg-green hover:bg-green-500 text-white px-6 py-1.5 text-base disabled:bg-green-100 sm:col-span-6 transition duration-150 ease-in-out rounded-full"
                    override="class"
